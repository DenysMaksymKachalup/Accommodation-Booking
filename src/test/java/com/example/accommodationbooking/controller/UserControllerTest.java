...
public class UserControllerTest {
    ...
    @Test
    @WithMockUser(username = "admin",roles = "ADMIN")
    public void updateUserInformation_returnUserResponseDto() throws Exception {
        UserUpdateRequestDto userUpdateRequestDto = new UserUpdateRequestDto("firstUpdate","lastUpdate");
